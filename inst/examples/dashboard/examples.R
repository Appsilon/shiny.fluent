...
# where each element is a shiny dashboard with a 'ui´ and ´sever´ elements
  ...
  names(examples) <- basename(examplesFiles) %>%
...
#   file.path("..", .)
# 
# examples <- buildExamples(examplesPaths)
