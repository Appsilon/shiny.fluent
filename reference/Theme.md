...
docs](https://developer.microsoft.com/en-us/fluentui#/controls/web/Theme).
...
`ThemeProvider` is a utility that applies contextual theming to its
child components. See the [official
docs](https://developer.microsoft.com/en-us/fluentui#/controls/web/themeprovider)
for details.
