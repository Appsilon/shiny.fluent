...
box::use(
  shiny[moduleServer, NS, observe, span],
...
The above code block loads the `ggplot2` package and generates a barchart with names of the sales reps on the X axis and the  summarized amount of deals on the Y axis.
